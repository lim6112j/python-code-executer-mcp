...
mcp = FastMCP("python-executor", host="0.0.0.0", port=19000)
    ...
    try:
        ...
        if changed_files:
            ...
            for f in changed_files:
                output += f"- http://localhost:19000/workspace/{f.name}\n"
        else:
...
if __name__ == "__main__":
    ...
    print("Starting MCP Server with static file serving on http://0.0.0.0:19000")
    print("SSE endpoint: http://0.0.0.0:19000/sse")
    print("Static files: http://0.0.0.0:19000/workspace/")
